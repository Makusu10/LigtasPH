...
- **Tests**: 227 pytest (incl. `tests/test_api_standardization.py`: error-envelope codes, pagination headers/envelope, idempotency replay/conflict, location UPSERT), plus settings/status/keys/banner/history/timezone suites. Windows note: suite assumes UTF-8 file reads (`encoding="utf-8"` fixed in `test_noah.py`).
